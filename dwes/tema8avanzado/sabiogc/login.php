...
<div class="col s10 m6 l4">
  <form method="post" style="display: inline;" action="acceso.php">
    ...
    <div class="input-field col s12 m12">
      ...
      <form method="post" style="display: inline;" action="registro.php">
        <div class="input-field col s2"></div>
        <div class="input-field col s10 m10">
        <button class="btn green darken-2" type="submit" name="registro">Registro<i class="material-icons right">send</i>
          </button>
        </div>
      </form>
    </div>
